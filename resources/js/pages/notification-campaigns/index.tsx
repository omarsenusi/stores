    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'حملات الإشعارات', href: '/notification-campaigns' }]}>
            ...
            <div dir="rtl" className="p-6 space-y-6 max-w-7xl mx-auto w-full">
                {/* Header Banner */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-indigo-950 via-slate-900 to-slate-900 p-6 rounded-2xl text-white shadow-xl border border-indigo-900/40">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            <Mail className="h-7 w-7 text-indigo-400" />
                            <h1 className="text-2xl font-bold tracking-tight">حملات البريد والإشعارات (Horizon Queue)</h1>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/notification-settings">
                            <Button variant="outline" className="bg-slate-800/80 hover:bg-slate-700 text-white border-slate-700 gap-2">
